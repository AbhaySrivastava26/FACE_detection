...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        resized_img = cv2.resize(crop_img, (50, 50)).flatten().reshape(1, -1)  # Adjusted to match 2775 features
    ...
    imageBackground[300:300+480, 640:640+640] = frame  # Adjust position as needed
